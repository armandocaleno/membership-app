...
<head>
    ...
    <title>Suscripcion experirada!</title>
    <style>
                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;"
                                            ...
                                            <p>Le informamos que su suscripción al plan <strong>{{ $suscription->plan->name }}</strong> ha vencido el día {{ $end_date->translatedFormat('d \d\e F \d\e\l Y') }}</p>
                                            
                                            <p
                                                style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                                                A partir de este momento, el acceso a algunas funcionalidades puede verse limitado o suspendido.
                                            </p>

                                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                                                Para continuar disfrutando del servicio sin interrupciones, le invitamos a renovar su suscripción comunicaádose al número 099 560 7147.
                                            </p>

                                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                                                Si ya realizó el pago recientemente, por favor ignore este mensaje, ya que la actualización puede tardar algunos minutos en reflejarse.
                                            </p>
